...
Tabell \ref{tbl:RIA} viser resultatet av
 ...
 alltid har indeks =0= i dette formatet); i dei neste har eg i tillegg
 med dei som hadde maksimalt ein annan yttarste \PRED{},
 osb. (kolonnen /maks. yttarst/).
...
Tidlegare nemnte eg at positiv LPT-informasjon kan føre til at lenkjer
 ...
 =RIA= har rett, 8 % viss me ser på alle lenkbare predikat) er nok
...
Eit problem som blir tydeleg med denne evalueringa er at lange lister
 ...
 testsettet måtte eg setje ei grense på =lfgalign= i denne evalueringa
 slik at me berre vel første lenkjekombinasjonen viss adjunktlistene
 har over åtte medlem[fn:45]. Med så flate strukturar og ingen
 ...
 det under eitt minutt, her blir altså /svært mange/ løysingar
...
# TODO: vel, punkt 1 og punkt 2 er jo ikkje skilt i materialet... men
# det var jo tydeleg frå eyeballing at det skjedde. Hmm.
