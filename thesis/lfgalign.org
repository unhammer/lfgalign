...
Krav (vi) i \citet[s.~5]{dyvik2009lmt} krev at viss F_s og F_t er
...
dei to filene og oppretter ein intern representasjon av
LFG-analysen. 
...
** min metode
(iii) og (iv) i \citet[s.~5]{dyvik2009lmp} krev LPT-korrespondanse
mellom (L av Pr av) kvart kjeldeargument og målargument/-adjunkt. Eg
krev i tillegg at f-strukturane deira kan samanstillast.
** merge
filene 
