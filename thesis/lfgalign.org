...
Dette vil seie at om to toppnodar XP og ZP er lenkja, slik at me må ha
ei lenkje mellom $\phi(XP)$ og $\phi(ZP)$, kan ikkje dotter til XP,
X', lenkjast med t.d. mor eller søster til ZP. Og om ZP dominerer ein
node WP, der $\phi(WP) \neq \phi(ZP)$, kan me heller ikkje ha ei
c-strukturlenkje frå X' til WP. Grunnen er at f-strukturane er sett
saman av informasjonsinnhaldet projisert av nodane, det vil aldri vere
grunnlag for å ha ei c-strukturlenkje som står i konflikt med
f-strukturlenkjer.
