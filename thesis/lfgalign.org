...
#+LaTeX_HEADER: \renewcommand{\BOthers}{mfl.\hbox{}}
#+LaTeX_HEADER: \renewcommand{\BOthersPeriod}{mfl.\hbox{}}

#+LaTeX_HEADER: \pagenumbering{roman}

### The org-mode TITLE command escapes curly parens, so we do it like this instead:
#+LaTeX_HEADER: \newcommand{\tittel}{{\large DASP350 -- Datalingvistikk og språkteknologi mastergradsoppgåve}\\\vspace{20mm}Syntaktisk fraselenking\vspace{25mm}}
#+TITLE: \tittel

### TODO: studentnummer
#+AUTHOR: Kevin Brubeck Unhammer\\\vspace{05mm}\\Institutt for lingvistiske, litterære og estetiske studier\\Universitetet i Bergen\vspace{10mm}\\Haust, 2010\vspace{15mm}\\\includegraphics{uib-emblem-svart}\vspace{10mm}
...
#+BEGIN_LaTeX
  ...
  Takk til dei involverte i Xpar-gruppa; då spesielt til
  hovudrettleiaren min Helge Dyvik, for god hjelp under utvikling av
  metoden, og for å alltid ha klart skiljet mellom prinsipp og
  implementasjon; og til birettleiar Koenraad De Smedt, for gode råd
  under skriveprosessen, og for å ha oppmoda meg til å skrive artikkel
  (noko som førte til mykje betre struktur i denne oppgåva). I
  tillegg, takk til Paul Meurer ved Uni Digital, som gav god hjelp med
  evalueringsmaterialet og georgisken, og til Yvette Graham frå DCU
  som hjalp til med endå meir evalueringsmateriale på kort varsel.

  Takk til Tiril for tolmod og oppmuntring, til Baldur for pelsterapi
  og fine turar, til begge for alle gode opplevingane gjennom ein lang
  skriveperiode.
...
** Innleiing
Ekte omsetjingar har kompliserte forhold mellom kjelde og mål.  I
 denne delen prøver eg å finne fram til kva som er den best moglege
 samanstillinga mellom frasane i ei omsetjing. Eg argumenterer for at
 «best» her må tolkast i forhold til eit formål; her er formålet å
 annotere ein trebank for lingvistiske studium, m.a. for å undersøkje
 ulike samsvar mellom kasusmarkering og semantisk rolletildeling.  Som
 utgangspunkt har eg visse krav for ordsamanstilling gitt i
 \citet{thunes2003eal}, saman med krava for frasesamanstilling i
 \citet{dyvik2009lmp}. Eg viser kvifor ein, for våre formål, må
 revidere kravet til Thunes om likskap i argumentstruktur. Eg gir
 nokre døme for å grunngje krava i \citet{dyvik2009lmp}, i tillegg til
 å utdjupe dei for å gjere dei enklare å implementere i kapittel
 \ref{SEC:implementasjon}. Dette involverer au å omformulere krava for
 c\hyp{}struktursamanstilling slik at dei ikkje refererer til
 ordlenkjer, berre f\hyp{}strukturlenkjer. Sidan eitt av måla med
 Xpar-prosjektet er å finne ut kor mykje
 frasesamanstillingsinformasjon me kan få ut av parallellismen i
 f\hyp{}strukturane (eller, sett frå den andre sida, kor uavhengig ein
 kan gjere seg av den bottom-up-informasjonen ei ordlenkje gir), blir
 det eit avleidd mål å formulere frasesamanstillingskrava med
 referanse til f\hyp{}strukturane der det går an.
...
Argumentpermutasjonane frå =argalign= prøver som nemnt ikkje reine
 ...
 inkludert i $argperm$, og =argloop= prøver desse rekursivt via
 =sub-f= på same måte som med argumentlenkjene. Lenkjene blir lagt til
 ein /kopi/ av argumentpermutasjonane, sidan det ikkje er sikkert at
...
Der det er umogleg å finne ein kombinasjon av argument- og
 ...
 unik f\hyp{}struktur, dvs. der =argalign= feilar, prøver =f-align=
...
Ein sideverknad av å byrje med ytre lenkjer og gå innover (prosessen
 til =f-align=) er at me automatisk unngår å prøve «kryssande»
 ...
 for setningar der alt me veit om lenkinga er at /setningane/ er
...
\label{SEC:impl-f-rangering}
 ...
 til desse f\hyp{}strukturane. Kvar enkelt grein i /branches/ er ei
 ...
 /link/ vere $(F_t,F_s)$ medan /branches/ er $\{ \{ a1a1tree, a2a2tree
 \}, \{ a1a2tree, a2a1tree \} \}$; kor $a1a1tree$ har $(a1_s, a2_t)$
 som /link/, osb. Viss desse argumenta ikkje har argument/adjunkt
 sjølve, vil deira /branches/ vere tomme, og deira /rank-f/ er
 då 1. For $F_t$ og $F_s$ vil funksjonen /rank-f/ returnere den greina
 som har best skåre[fn:30], gitt ved /rank-branch/.
 ...
 /subrate-sum/. Me returnerer produktet av skårane frå
...
Programmet =lfgalign= følgjer krav \ref{krav:c-pro} (ev. med $LL$ i
 ...
 nodar. Prosedyren =c-align= i kodefigur \ref{algo:c-align}
...
Sidan =c-align= kallar =add-links= for kvar av sidene, får me to
 ...
 \ref{SEC:f-lenkje-utan-c-node}. Om =*pro-affects-c-linking*= er
 usann, filtrerer me ut alle lenkjer frå =f-alignment= kor det eine
 elementet ikkje opptrer i c\hyp{}strukturen, før kall på =c-align=.
 I figur \ref{fig:gaiGo} i kapittel \ref{SEC:ideell} har me to
 f\hyp{}strukturlenkjer som ikkje finst i c\hyp{}strukturen; om me
 ikkje filtrerer ut desse, vil det /norske/ treet bli delt i tri
 nodemengder (noko me berre ønskjer viss =*pro-affects-c-linking*= er
...
#+END_LaTeX
 ...
 =lfgalign= på LFG\hyp{}analysar av parallelle setningar. Eg ser på manglar
...
Dei vanlegaste metodane er basert på sannsynsmodellar[fn:36], kor den
 ...
 modellparametrane slik at skårane blir betre. Eg gir her eit /svært
 ...
 /lingvistisk samanstillingsfilter/ for å opprette ein frasesamanstilt
 ...
 sett kan ein opprette lenkjer mellom alle moglege nodepar[fn:39].
...
som jo inneheld feil argumentpermutasjon (me får då au feil
 ...
 til dei to verba /ikkje/ er parallelle[fn:51] -- \p{mi-codeba} har
 ...
 t.d. leggje til informasjonen om at /brouns/ og /Browne/ har
...
I setning 2.pl og 0.pl har konstruksjonen /være på vei hjem/ blitt
 omsett til /bruneba/, direkte omsett /dreie/. F\hyp{}strukturane i
 ...
 får etter at /amundsen/Amundsen/ og /skola/skole/ er lagt til i
 LPT-tabellen.
...
Det andre testsettet mitt er ei mengd med 4000 automatisk
 ...
 f\hyp{}strukturlenkjene ein får ved å køyre =lfgalign= med dei
 lenkjene som kjem frå =RIA=-metoden[fn:44] i
 ...
 alle oppslaga frå Ding-ordboka[fn:54]. I tillegg køyrer eg testane
...
Tabell \ref{tbl:RIA} viser resultatet av
 ...
 har alltid indeks =0= i XLE\hyp{}formatet og er lett å identifisere); i
...
1. Fragmentariske f\hyp{}strukturar gir dårleg samanstilling (søppel
   inn, søppel ut)
...
element. Setningsparet i \Next nedanfor, 38.pl/39.pl i =mrs=-testsettet, har
...
Når det gjeld kollokasjonen /there is/es gibt/, vil me med ein
 LFG-lenkja trebank sjølvsagt kunne søkje etter kombinasjonen av
 ordlenkjene, men dette blir ikkje ei lenkja /eining/ som me kan søkje
 etter. Derimot kan me finne /kombinasjonen/ av lenkjene /there/es/ og
 /is/geben/ i same setning (noko som burde skje ganske ofte); eller me
...
Dette kan me ta eit steg vidare. Sidan samanstillingane er direkte
 avleidd frå utdata frå grammatikkar, bør =lfgalign= vere mogleg å
 ...
 dette /parsebanking/, her kan me kanskje snakke om /parallell
 parsebanking/.
...
Her står koden for å køyre analysane frå tabell \ref{tbl:RIA}. Først
 ...
 klargjere ordboka og testsettet frå =lfgalign=-mappa med
...
[fn:44] Prolog-filene med f\hyp{}strukturar, og lenkjer mellom
        ...
        [[http://www.computing.dcu.ie/~ygraham/software.html][http://www.computing.dcu.ie/\mytilde{}ygraham/software.html]] under GNU
        Lesser General Public License. I tillegg finst Prolog-filer
        som inkluderer c\hyp{}strukturar for 1000 setningar på
        [[http://www.computing.dcu.ie/~ygraham/sample_de.tar.gz][http://www.computing.dcu.ie/\mytilde{}ygraham/sample_de.tar.gz]] og
        [[http://www.computing.dcu.ie/~ygraham/sample_en.tar.gz][http://www.computing.dcu.ie/\mytilde{}ygraham/sample_en.tar.gz]].
...
[fn:54] Tilgjengeleg frå [[http://www-user.tu-chemnitz.de/~fri/ding/][http://www-user.tu-chemnitz.de/\mytilde{}fri/ding/]]
