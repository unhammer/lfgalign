...
\fxnote{alt i denne delen er uferdig...}
...
# resultat av å automatisk samanstille norske og georgiske setningar osb
 ...
 f-strukturlenkjinga. \fxnote[inline,nomargin]{«eg kjem tilbake til
 dette blah»}

 Kjeldematerialet mitt for denne evalueringa er ei mengd med omtrent
 tredve \fxnote[inline,nomargin]{med mindre det finst fleire?}
 LFG-analyserte testsetningar på norsk og georgisk[fn:33], frå eit
 ...
 parallelltekst[fn:34], og materialet mitt er sjølvsagt alt for lite
...
** N-grambaserte metodar
   \fxnote{Planen er altså å fortelje litt om dei alternative
 metodane, og så samanlikne med dei...er litt usikker på korleis eg
 skal samanlikne då.}
 ...
 ein-mange-samanstilling ei /ordsamanstilling/; når
 ...
 (dvs. summen av $p$ for alle setningane).  For å finne $p$ for
 ...
 Ein av dei vanlegaste treningsmetodane er /sannsynsmaksimering/, som
 lèt ein rekne ut elles umoglege sannsynsproblem ved å iterativt endre
 modellen slik at skårene blir betre. Eg gir her eit /svært forenkla/
 oversyn over korleis dette går føre seg.  Me byrjar med å setje $p_0$
 for alle moglege samanstillingar og ordpar til ein viss verdi,
 kanskje på ein tilfeldig måte. Så genererer me eit falskt målkorpus
 basert på kjeldekorpuset kombinert med $p_0$. Me tel opp
 samanstillingsførekomstene her i ein tabell; når me ser ordet /Es/ i
 ei setning omsett til /There is/, vil tabellraden med /Es/ få auka
 frekvensskåre i kolonnane til /There/ og /is/ -- men sidan dette
 målkorpuset var vekta på $p_0$ vil denne frekvensen au vere vekta, og
 treng ikkje vere 1 eller 0. Så går ein gjennom korpuset slik og gir
 skårar for alle moglege ordomsetjingar, til slutt vil sannsynlegvis
 raden til /es/ og /there/ ha høgare skåre enn /es/ og /is/. Me reknar
 så ut $p_1$ ved å telje opp dei relative frekvensane til alle
 tabellradene; dette blir nytta i neste iterasjon for å generere det
 falske målkorpuset.
...
*** Døme
   \fxnote[inline,nomargin]{Grundig gjennomgang av eit døme, for samanlikning med
 N-grambaserte metodar}
...
- Kva informasjon får me ut av lenkjinga

- Kva informasjon ville me fått ut av ei rein N-gram-lenkjing

  - ...og korleis kan N-grambaserte metodar nyttast til tre-lenkjing
    (Samuelsson & Volk)

*** Men korleis gjenfinne there is/es gibt?
...
** Kor mange setningspar treng LPT-korrespondanse for å bli rette
Sidan eit mål med oppgåva er å finne ut av kor lite
bottom-up-informasjon ein kan klare seg med, går eg her gjennom
setningane i testsettet mitt for å sjå kor mange av dei som krev
LPT-informasjon for å unngå feil lenkjer mellom argument/adjunkt av
same predikat. Merk: sjølv om testsettet viser ei vid rekkje
syntaktiske fenomen, er det langt frå å vere eit representativt
korpus.

«min LPT-par» i tabellen er «kor mange LPT-korrespondansar som trengst
for å få rette f-lenkjer»; «moglege LPT-par» viser moglege mengder med
minimal LPT-informasjon som er nok til at me får rett analyse (mange
mengder i denne kolonnen vil altså seie at det er mange måtar å få
rett analyse på). Viss eit tal står i parentes har setningsparet andre
problem enn berre LPT-korrespondanse som gjer at ikkje alt som skal
bli lenkja, blir lenkja.
...
67.pl og 68.pl manglar adverbialet frå analysen; /abramsis/ er POSS i
...
71.pl og 72.pl viser at koordinering ikkje fungerer... får berre
=((mo-svla . ankomme) (pro . pro))= men burde vel få =((mo-svla
. ankomme) (da . og) (Abrams . Abrams) (Browne . Browne))=.  Dette
skjer fordi koordineringar ikkje har PRED-element i analysane, men i
staden er representert som =(("REF-COORD" . "+") ("NUM" . "pl")
("COORD-FORM" . "og") ("CASE" . "nom")) {1, 2}= kor det på slutten
altså er ei /mengd/ med 1 og 2 (Abrams og Browne). Me kan t.d. løyse
...
argument). Same problemet med 73.pl og 74.pl, her får me berre =((da
. og))= sidan det er ein VP-koordinering.

Dette dømet demonstrerer ein veikskap med =lfgalign=: om ein skal
nytte =lfgalign= med nye LFG-grammatikkar, som kanskje har andre
...
omsett til «bruneba» `dreie'. Lenkjinga gir =((*-bruneba . være)
(amundsen . Amundsen) (skola . vei))= etter at amundsen/Amundsen står
...
Setning 13 + 10 i sofie har fått =(soPi . hun)= =D har liknande
...
Me får her =((0 . 0) (15 . 18) (17 . 6) (10 . 5))=, dvs. =((Se-Hveva
. svinge) (pro . hun) (pro . _nå) (soPi . inn))=. Desse pro-elementa
på georgisk skal sjølvsagt /ikkje/ lenkjast med adjunkta på norsk; her
...
ein legg inn ei omsetjing for /nå/, får ein ut =((Se-Hveva . svinge)
(pro . svinge) (pro . hun) (soPi . inn))=, som kanskje er hakket
betre, men sidan mange-mange-lenkjing berre er to-til-ein så langt,
vil LPT-informasjon om både /nå/ og /inn/ resultere i at denne
setninga /ikkje får nokon lenkjing/. Dette er kanskje å føretrekkje,
...
\fxnote{TODO: problematiser at N-grambaserte metodar vil få alt for
mange lenkjer her (og i 2/0-dømet) som ikkje eigentleg høyrer heime.}
...
*** Koordinering
\fxnote[inline,nomargin]{Setning ka/71.pl og nb/72.pl}
** Oppsummering
...
[fn:36] Det finst au /heuristiske/ metodar, t.d. basert på
        ...
        saman i omsetjingar enn ein ville forventa).
