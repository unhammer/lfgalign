...
*** Top-down-lenkjing av f-strukturar, og problemet med sykliske grafar
      ...
      \p{bjeffe}, difor får løysinga ut jaGli-hund to gonger. TODO:
      byrje med det enkle dømet, så dette.}
...
f-strukturane er sykliske og har fleire stiar til same element.
Setningsparet i \Next gir eit døme på dette. Predikata i setningane
bør kunne lenkjast, men analysane gir nokre intrikate problem.
