...
\ex. \{(\p{mi-codeba} . \p{rekke-hand})
 ...
 same predikat. Men merk: sjølv om testsettet viser mange ulike
...
den georgiske f-strukturen har dette som ein \POSS{} under
\SPEC{} av f-strukturen til /suraTi/, i staden for å vere eit
