...
# resultat av å automatisk samanstille norske og georgiske setningar osb
 ...
 syntaktiske situasjonar. Analysane er manuelt disambiguerte.  Dette
 materialet er sjølvsagt alt for lite for statistisk samanstilling, så
 når eg samanliknar med N-grambaserte metodar gir eg desse «perfekte»
 lenkjer (så gode som det vil vere mogleg å få).

\fxnote[inline,nomargin]{Kvifor georgisk: ...}
...
** N-grambaserte metodar
 ...
 skal samanlikne då.}  Dei fleste metodane for frasesamanstilling er
 N-grambaserte; difor er det naturleg å samanlikne metoden i
 =lfgalign= med slike metodar.
