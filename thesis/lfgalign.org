...
#+BEGIN_LaTeX
\begin{quotation}
An article about [...] science in a scientific publication is
\textbf{not} the scholarship itself, it is merely \textbf{advertising}
...
beste evne i eit Common Lisp[fn:16]-program.
...
Setningsparet i \Next (frå \citet[s.~40]{riezler2006gmt}, nemnt i del
\ref{SEC:bakgrunn}, ein metode som går frå fraselenkjer til
f-strukturlenkjer) bør kunne lenkjast, men gir nokre intrikate
problem.
...
\p{appreciation} har me LPT-korrespondanse mellom \p{da} og \p
...
**** TODO XLE er nede igjen, får ikkje dobbeltsjekka analysen :/
...
[fn:2] Tilgjengeleg frå http://github.com/unhammer/lfgalign som fri og
       open programvare under GNU General Public License versjon 3
       eller seinare (av grunnar som burde vere openberre, men sjå
       \citet{pedersen2008enm} og \citet{barnes2010pcc} for velformulerte
       argument).
