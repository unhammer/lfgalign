...
Leksikalsk-Funksjonell Grammatikk (i tillegg til eit par eigne
termar). Difor gir eg her eit kort oversyn over det som kan vere nytt
for dei som er meir vand med andre grammatiske rammeverk.
...
Ein modellteoretisk grammatikk kan i tillegg skildre strukturen (eller
dei moglege strukturane) til /fragment/ av setningar, og denne
 ...
 *f-strukturen* («functional structure»). Figur
...
c-struktur-f-strukturavbildinga $\phi$. I dette tilfellet går $\phi$
av alle nodane her til f-strukturen $f$
