...
Det andre alternativet er å ikkje gjere forskjell på IP, I' og I når
 ...
 I' i figur \ref{fig:gaiGo} \citep{dyvik2010pc}.
...
** Bruksområde
# Frasesamanstillingane frå =lfgalign= har ein kvalitativt forskjellig
#  informasjon frå den du får med berre N-gramlenkjer eller
#  konstituentlenkjer. 

I denne delen ser eg kort på moglege bruksområde for
 samanstillingsannotasjonen frå =lfgalign=.
...
Formålet med annotasjonen er jo å lage ein trebank for lingvistisk
 ...
 liste over lenkjer mellom frasar med ulik kasus, osb.  Og med eit
 grensesnitt som skildra i \citet{dyvik2009lmp} blir dette endå
 enklare, for dei spørjingane grensesnittet tillèt.
 
I døme \ref{ex:sie-gefallen} i kapittel \ref{SEC:lik-argstr} viste eg
 ...
 argumentstruktur. Programmet mitt vil her gi begge løysingar, ei
 ...
 objekt) kan me lære slike argumentstrukturskifte; t.d. vil me i /der
 Tonfall gefällt mir nicht/jeg liker ikke tonen/ ha nok
 LPT-informasjon til å finne rett løysing. Med ein trebank annotert
 med f-strukturlenkjer vil slik «læring» ikkje involvere meir enn å
...
Men i tillegg til desse måla, vil lenkjene til =lfgalign= gi
 ...
 dependensstrukturar åleine. Og sidan avbildinga frå c-strukturnodar
 til f-struktur er mange-til-ein, kan me innanfor eitt tre ha fleire
 «N-gram» per f-strukturhovud. Me kan altså ha diskontinuerlege
 mange-mange-lenkjer på c-strukturnivå. Slike relasjonar finn me ikkje
 med ein metode som berre ser på lenkjer mellom konstituentdelmengdene
 av ein N-gramtabell \citep{samuelsson2007apa} eller ein metode som
 ikkje har ei kopling frå f-struktur til c-struktur
 \citep{graham2009fts}.
