...
argumentpermutasjonen.

Om me i tillegg krev at f-strukturane deira kan samanstillast kan me
utelukke lenkjing av $F_s$ og $F_t$ nedanfor\fxnote{nemne dette i kapittelet over}:

: F_s[ PRED planlegge<eg,1>      F_t[ PRED plan<I,3>
  :    XCOMP 1[gi (opp)]      ]       XCOMP 3[ give<I,him,it> ]

Men det kan vere at me ikkje /vil/ krevje dette i alle tilfellet. Den
enklaste løysinga blir då å spørje etter dei argumentpermutasjonane
som har flest medlem.

** Kan me gjere f-struktursamanstillinga fullstendig bottom-up?
