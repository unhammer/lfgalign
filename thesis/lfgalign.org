...
- PRED må ha LPT-korrespondanse
- arg må ha LPT-korrespondanse med arg/adj
  - problematiser: må me ha /PRED-lenkje/ frå arg til arg/adj? (ikkje
    krevd no...men kan rangere)
- kryssande f-lenkjer?
- mange-mange-f-lenkjer?
...
$LL(n_t)$. Ulenkja nodar står ikkje i vegen for lenkjing av $n_s$ og
$n_t$.  For at me skal unngå å lenkje I' og Vfin i figur
\ref{fig:ikkjesub} må altså /det/ og /seg/ òg vere ordlenkja til
/gaiGo/, på ein måte som let oss sjå på mange-til-ein-ordlenkjene som
delelege.\fxnote{TODO forklar}


Eg vel i staden å definere kravet i form av f-strukturlenkjer på
preterminale nodar, og dimed unngå krav på ordnivå og delelege
mange-til-ein-lenkjer.
