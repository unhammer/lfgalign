...
\end{scope}
\end{tikzpicture}
   \caption{Enkel lenkjing av c-strukturnodar mellom norsk og nederlandsk}
...
I-nodane berre dominerer verba, og au kan lenkjast.
...
\fxnote[inline,nomargin]{TODO til det med dominans nemndt tidlegare:}
...
#+BEGIN_LaTeX
  ...
  \end{tikzpicture}
     \caption{Sjølv toppnodane kan stå ulenkja}
