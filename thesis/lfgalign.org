...
dette som er strategien til programmet =lfgalign= i kapittel
...
vere /fleire/ ytste f-strukturar, alle desse kan då potensielt
...
\label{SEC:diskusjon}
 ...
 frå =lfgalign= med dei som er mogleg å få med andre metodar, då
...
** Materiale
 ...
 georgisk[fn:33], frå eit testsett kor setningane er valde for å
 illustrere ei vid rekkje ulike syntaktiske situasjonar (kalla =mrs=
 nedanfor), i tillegg til eit par setningar frå Jostein Gaarders
 /Sofies Verden/ (kalla =sofie= nedanfor) på norsk og
 georgisk. Analysane er manuelt disambiguerte.

 Eg har ikkje tilgang på noko større setningssamanstilt georgisk-norsk
 parallelltekst[fn:34], og materialet i =mrs= og =sofie= er sjølvsagt
 ...
 her. I staden har eg prøvd å sjå på kva for fenomen som /kan/ gi
 ...
 frå programmet =RIA= \citep{graham2009osr,graham2009fts}, kor språka
...
** N-grambaserte metodar
 ...
 mange-ein-samanstilling ei /ordsamanstilling/; når
 mange-mange-lenkjer er med har me ei /frasesamanstilling/.
 ...
 slik at skårene blir betre. Eg gir her eit /svært forenkla/ oversyn
 ...
 (verdiane me har i $p_0$ har ofte mykje å seie), men me /er/
 garantert at korpussannsynet[fn:37] aldri vil bli mindre i neste
 iterasjon.
 ...
 lenkjer mellom alle moglege nodepar[fn:39]. 
...
** Kor avhengig er =lfgalign= av LPT-korrespondanse?
...
\ex. \{(\p{mi-codeba} . \p{rekke-hand}) (\p{Browne} . \p{sigarett}) (\p{sigareti} . \p{Browne}) (\p{Abrams} . \p{Abrams})\} 
 ...
 /ikkje/ er parallelle -- \p{mi-codeba} har <\p{Abrams}, \p{sigareti},
 \p{Browne}>, medan \p{rekke-hand} har <\p{Abrams}, \p{Browne},
 \p{sigarett}>, og me har eit rangeringskriterium som føretrekkjer lik
 følgje over ulik. Men ved å t.d. leggje til informasjonen om at /brouns/
...
| setning         | l_s | l_t | min LPT | moglege LPT-par                          | merknad |
|-----------------+-----+-----+---------+------------------------------------------+---------|
| mrs 0.pl 0.pl   |   1 |   2 |       0 |                                          |         |
| mrs 1.pl 1.pl   |   2 |   2 |       0 |                                          |         |
...
\ex. \a. abramsis suraTi movida.\\
 ...
 /Abrams/ står som argument til \p{bilde}). Programmet =lfgalign= finn
 ...
 /abramsis/ ikkje er mogleg å finne via argument/adjunkt av
 ...
 jo vere mogleg å finne det via /suraTi/. På den norske sida er
 /Abrams/ mogleg å finne gjennom /bilde/, og er ikkje sett på som noko
 ytste predikat, så /abramsis/ og /av Abrams/ blir ikkje lenkja.
...
ein legg inn ei omsetjing for /nå/, får ein samanstillinga i \Next:
...
er to-til-ein så langt, vil LPT-informasjon om både /nå/ og /inn/
resultere i at denne setninga /ikkje får nokon lenkjing/. Dette er
kanskje å føretrekkje, når me først skal krevje likskap i
argumentstruktur for å lenkje[fn:43]. Då er det opp til grammatikarane
...
inndata til =RIA=, og samanlikne med unionen, og kor mange
...
alle blir lenkja. Viss =lfgalign= har same samanstilling som =RIA=,
vil snittet av dei to vere lik unionen.
...
f-align:
|  set | isect | union | isect/union | # lfgalign | # ria | # srcs | # links |
|------+-------+-------+-------------+------------+-------+--------+---------|
| 0000 |  1819 | 11249 |  0.16170326 |       6170 |  6978 |  10131 |  102025 |
| 0001 |  1880 | 11231 |  0.16739382 |       6049 |  7142 |  10225 |  103798 |
| 0002 |  1801 | 11000 |  0.16372727 |       5920 |  6945 |   9916 |   97956 |
| 0003 |  1796 | 11107 |  0.16169982 |       6022 |  6954 |  10071 |  101109 |

random-f-align: TODO
sents_0000
isects:622
(unions:15165)
lengths_lfgalign:8809
lengths_ria:6978
possible srcs:10131
possible links:102025
sents_0001
isects:643
(unions:15412)
lengths_lfgalign:8913
lengths_ria:7142
possible srcs:10225
possible links:103798
sents_0002
isects:661
(unions:14874)
lengths_lfgalign:8590
lengths_ria:6945
possible srcs:9916
possible links:97956
sents_0003
isects:618
(unions:15093)
lengths_lfgalign:8757
lengths_ria:6954
possible srcs:10071
possible links:101109

 Det er tydeleg at overlappet mellom =RIA= og =lfgalign= er svært låg
 på dette materialet[fn:46]. 

 Ved nærare ettersyn viser det seg at dette korpuset har mange
 fragmentariske analysar, og som oftast er det mange «ytste
 f-strukturar» (gjerne 10 i kvar setning). Implementasjonen min reknar
 ein f-struktur for å vere ein av desse ytste om han ikkje er referert
 til som argument/adjunkt av andre f-strukturar. Ytste f-strukturar
 blir handsame som om dei er på same nivå i f-strukturen -- viss det
 eigentleg finst ein intern struktur mellom desse blir det
 ignorert. Det vil altså seie at for store deler av analysane får
 =lfgalign= ingenting ut av f-strukturen (gjennomsnittleg
 setningslengd i materialet er 9,8 ord).

# TODO gjennomsnittleg unreferenced-preds-lengd
...
argument/adjunkt blir prøvd lenkja; men når det er snakk om ti adjunkt
på kvar side tek det =adjalign= ca. 46 sekund (på ein vanleg
datamaskin med 2,1 GHz, 3GB RAM) å finne alle moglege
lenkjekombinasjonar[fn:45].
...
I denne delen diskuterer eg nokre opne problem, og moglege måtar
metoden kan betrast på.

*** Fragmentariske analysar
Som nemnt i del \ref{SEC:ria} har =lfgalign= problem med
fragmentariske f-strukturanalysar. Her bør det vere mogleg å dele opp
lenkjingsoppgåva i først å finne fragment som sannsynlegvis
korresponderar, og så sende kvar av desse til vanleg
f-strukturlenkjing.
*** Bør LPT-kravet implementerast som eit rangeringskrav?
Som nemnt i del \ref{SEC:feilanalyse} kan ufullstendig informasjon i
LPT-tabellen føre til at programmet avskjerer feil. 

I implementasjonen bør kanskje kravet om LPT-korrespondanse flyttast
ut frå f-strukturlenkjinga, og inn i rangeringa, for å ikkje stole på
at bottom-up-informasjonen vår er perfekt.
...
*** Rangeringsproblem
**** argument-argument > argument-adjunkt (ikkje implementert!)
...
[fn:33] Som nemnt er georgisk eitt av språka nytta i Xpar-prosjektet;
        og det er nok det som har mest typologisk avstand frå
        norsk. Georgisk-norsk burde difor vere eit passande språkpar
        for evalueringa.

[fn:34] Dette måtte i tillegg vore LFG-analysert og disambiguert for
        at eg skulle kunne samanlikne med =lfgalign=.
...
[fn:39] Ein kan sjølvsagt enkelt unngå lenkjing frå to søsternodar på
...
[fn:41] Sjølve trebanken \citep{samuelsson2006pap} og
        ...
        http://kitt.cl.uzh.ch/kitt/treealigner) opnar for manuelle
        ...
        kan me ikkje få mange-mange-lenkjer.
...
[fn:43] Om eit slikt setningspar er gitt til ein N-grambasert metode,
        ...
        trebank. Men, om /nå/ sjeldan står i omsetjingar av
...
[fn:45] I denne evalueringa vel =lfgalign= berre første
        lenkjekombinasjonen viss adjunktlistene har over åtte medlem,
        for å i det heile teke kome seg gjennom analysane. Med så
        flate strukturar og ingen LPT-informasjon er det usannsynleg å
        ende opp med rett kombinasjon uansett. Med denne «avskjeringa»
        på plass tok heile korpuset på 4000 setningspar rett under tri
        timar å samanstille.

[fn:46] Denne testen blei køyrt på revisjon
        =45feb03e3c2b8eefcad2d995e9f5d779c7264565= av =lfgalign=.
