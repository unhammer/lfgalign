...
\fxnote[inline]{TODO: implementere :->}) konstruerer moglege
...
\fxnote[inline]{Rangering er ikkje implementert enno (akkurat no gir
...
c-strukturnodar definerer frasesamanstillinga\fxnote{til
...
*** SKRIV viss me har LPT (og altså lenkje i f-alignment), men ikkje ekte f-lenkje
...
\fxnote{kan me \textbf{fjerne} visse f-samanstillingar mha. c-strukturinfo?
    dvs. disambiguere...
