...
| metode                     | maks. yttarst | snitt | union | lenkjer | \texttt{RIA}-lenkjer | snitt / \texttt{RIA} |
|----------------------------+---------------+-------+-------+---------+----------------------+----------------------|
...
# TODO: berre 52 med 0 unreferenced preds, men 2527 par har ikkje
# eksplisitt 'Fragment' i analysane -- kva er det me ikkje får med oss
# her?
