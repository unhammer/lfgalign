...
#+END_LaTeX
 ...
 mellom nodane viser frasehierarkiet i analysen av setninga.  I
 ...
 *diskontinuerleg konstituent*.
 ...
 I denne oppgåva nyttar eg termane /lenkjing/ og /samanstilling/ i
 omtrent same tyding som dei engelske termane /link/ og
 /alignment/. Ei samanstilling er ei mengd lenkjer. Merk at ei
 enkeltlenkje treng ikkje å vere ein-til-ein.  Lenkjer og
 samanstillingar er ekvivalensforhold som me kan finne mellom
 lingvistiske /representasjonar/ (f-struktur, c-struktur) eller
...
| \texttt{tilfeldig} |  2544 | 60544 |   35069 |       28019 | 0,0907              |
 ...
 adjunkt på kvar side tek det =adjalign= ca. 46 sekund (på ein vanleg
 datamaskin med 2,1 GHz, 3GB RAM) å finne alle moglege
 lenkjekombinasjonar. For å i det heile teke kome meg gjennom
 testsettet endra eg på =lfgalign= i denne evalueringa slik at me
...
problem. Ein av grunnføresetnadene til =lfgalign= er at analysane har
