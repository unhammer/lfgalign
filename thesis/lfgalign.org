...
lenkje frå eitt til tre PRED. Igjen vil me då sjå på dei resterande
...
løysingar lenkjingsproblemet; i alle situasjonar der me kan krevje
...
difor ikkje treng LPT-korrespondanse med argument/adjunkt av $q$. I
tillegg kan det jo hende at dette $a_p$ sjølv kan samanføyast med eit
av sine argument/adjunkt.

I tillegg er det ønskeleg å først sjå etter samanstillingar som
føreset syntaktisk likskap, før ein ser etter slike
omsetjingsskifte. Viss det er mogleg å opprette ei samanstilling på
bakgrunn av lik syntaks, vil me prioritere denne: den viktigaste
informasjonen me har å gå på er at setningane er omsetjingar og difor
har ein viss likskap -- Ockhams barberkniv gir oss då grunn til å
velje ei løysing som føreset lik syntaks over ei løysing som føreset
ulik syntaks.
...
føringane gitt over, og alle dei andre lenkjingskrava er dekkja.
*** SKRIV (reinskriv) om global tyding, ikkje-komposisjonell..    :ROTETE:
