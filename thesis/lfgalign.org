...
Eg samanliknar her f-strukturlenkjene ein får ved å køyre =lfgalign=
 ...
 prøvde eg med delmengder av testsettet kor eg filtrerte ut analysar
 med mange «yttarste f-strukturar».
...
Samanlikninga skjer ved å, for kvar setning i korpuset, telje opp kor
 ...
 mange f-strukturlenkjer =RIA= har i det heile for å få ein slags
 «dekning», og med kor mange lenkjer =lfgalign= har for å få ein slags
 «presisjon» -- dette føreset sjølvsagt at =RIA=-lenkjene er korrekte.
...
Viss me har to setningar som kvar har tri \PRED{}-element, finst det
 ...
 =lfgalign= har same samanstilling som =RIA=, vil snittet av dei to ha
 like mange lenkjer som =RIA= har, og like mange som =lfgalign= har
 (medan viss det er eitt av desse orda som =lfgalign= ikkje har
 lenkja, vil snitt / =RIA= gå ned, medan snitt / =lfgalign= held seg
...
Resultatet av samanlikninga står i tabell \ref{tbl:RIA}. Kolonnen
 ...
 altså alle lenkjene vore like, og testmetoden ville ha funne alle
 lenkjene som =RIA= fann (dekning). Viss forholdet mellom snittet og
 lenkjene i testmetoden var 100 % ville alle lenkjene i testmetoden ha
 vore inkludert i =RIA= (presisjon).  Det er tydeleg at overlappet
 mellom =RIA= og =lfgalign= er svært lågt på dette materialet[fn:46],
 men iallfall meir enn dobbelt så stort som ein ville forvente om det
...
Tidlegare nemnte eg at positiv LPT-informasjon kan føre til at lenkjer
 ...
 =lfgalign= berre ein fjerdedel så mange lenkjer som =RIA=.  Det er
 kanskje ein del feil blant lenkjene i =RIA=-testsettet; men sjølv om
 halvparten av lenkjene til =RIA= var feil, burde me sjå høgare snitt
 mellom =lfgalign= og =RIA= viss ordboka førte til betre lenkjer. Det
 viser seg allereie med første ord i testsettet kvifor dette skjer:
 ordboka omset engelsk /adoption/ med tysk /Adoption/ (og gir ingen
 andre omsetjingar), medan /adoption/ i denne setninga er nytta i ei
 anna tyding og blir omsett til /Genehmigung/ (som har ti andre
 omsetjingar i Ding, men altså ikkje den me er ute etter).  Det er
 sannsynleg at dei gjenståande lenkjene er av høg presisjon, men ei så
 låg dekning (12 % viss =RIA= har rett, 8 % viss me ser på alle
 ...
 =lfgalign= ingenting ut av f-strukturen.  Sidan programmet er meint
 for trebankbygging med høg presisjon treng det ikkje vere negativt at
 dekninga er /litt/ lågare; i tillegg vil me kanskje forvente meir
...
Kode for å køyre analysane frå tabell \ref{tbl:RIA} igjen. Linjene er
i same følgje som tabellradene: 
...
[fn:46] Testen utan ordbok blei køyrt på revisjon
        ...
        =3c5e1560eac45e34e3af1db4124a714427b2859e=.  Sjå funksjonen
        =ev-ria=.
