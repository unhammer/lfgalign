 ...
 *diskontinuerleg konstituent*.
  ...
  nodane i c-strukturen som saman projiserer denne 
  f-strukturen, t.d. ein VP-node med dominerande IP og CP
  \citep[s.~126]{bresnan2001lfs}. 
  \fxnote[inline,nomargin]{dette har eg vel sagt allereie:}
  Sidan dette er inversen av ein
