...
\label{SEC:innleiing}\pagenumbering{arabic}
   ...
   \\\vspace{0.2cm}(Wilhelm von Humboldt)
   \end{quotation}

  % \begin{quotation}\raggedleft{}
  % I begynnelsen var ordet -- på slutten, frasen. % vel, klisjeen 
  % \\\vspace{0.2cm}(Stanisław Jerzy Lec)
  % \end{quotation}
...
\label{SEC:ideell}
   ...
   \\\vspace{0.2cm}(Jorge Luis Borges)
   \end{quotation}
...
\label{SEC:implementasjon}
   ...
   or prove.
   \\\vspace{0.2cm}\citep[s.~466]{pedersen2008enm}
   \end{quotation}
...
\label{SEC:diskusjon}
   ...
   \\\vspace{0.2cm}(ukjend, via Steve Gibson)
      \end{quotation}
