...
Ved å ha ei ein-mange-lenkje, frå \emph{la-fryse} til både \emph{la} og \emph{fryse},
 ...
 av argumenta til \emph{la} og \emph{fryse}, desse må alle ha
 LPT\hyp{}korrespondanse med argument eller adjunkt av \emph{la-fryse}, og
 omvendt må alle argument av \emph{la-fryse} ha LPT\hyp{}korrespondanse med
 argument eller adjunkt av \emph{la} eller \emph{fryse} (utanom
 \XCOMP{}-argumentet til \emph{la}, som allereie har ei lenkje). Ein kan
 tolke dette som om \emph{la} og \emph{fryse} var samanføyd til eitt predikat
 som kravde to argument (her: \emph{ho} og \emph{huset}).
