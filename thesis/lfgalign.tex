...
\section{\textbf{SKRIV} Funksjonelle c-strukturnodar}
\label{sec-3.10}
...
omsetjingar (t.d. \emph{fordi} og \emph{whether}), bør me ikkje ein gong lenkje
komplementa\footnote{Skal ein lenkje ordet \emph{som} (utan PRED) med ordet \emph{which} (med
...
det gjekk bra» med \emph{that} i «he saw that she drew a picture»).
