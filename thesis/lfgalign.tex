...
\texttt{lfgalign} i kapittel \ref{SEC:implementasjon}.


\section{\textbf{SKRIV} Eit kort oversyn over leksikalsk-funksjonell grammatikk}
\label{sec-2.2}
...
\begin{itemize}
\item modellteoretisk (vs enumerativt) \fxnote[inline,nomargin]{TODO hente Pullum-del frå kap.3 og leggje inn her kanskje?}
\item f-struktur
\item c-struktur
