...
\ex. La $m$ vere mengda av ein-til-ein LPT-korresponderande
     ...
     sine. \emph{Følgjeskåren} til $F_s$, $F_t$ er då $\frac{n}{m}$.
...
\ex. La $m$ vere mengda av ein-til-ein LPT-korresponderande
     ...
     eller som er lenkja på f-strukturnivå. \emph{Djupnskåren} til $F_s$,
     $F_t$ er då $\frac{n}{m}$.
...
skåre til f-strukturar med mange argument/adjunkt\footnote{Sidan det ikkje er meininga å nytte denne skåringa i
...
I denne delen gir eg ei evaluering av resultata frå å køyre \texttt{lfgalign}
...
å få frå \texttt{lfgalign} med dei som er mogleg å få med andre metodar, då
...
orda i setninga på målspråket\footnote{$e$ for engelsk og $f$ for fransk, sjølvsagt. }, er ei N-gramsamanstilling
...
litteraturen om statistiske metodar er dette ei \emph{ordsamanstilling};
når mange-mange-lenkjer er med har me ei \emph{frasesamanstilling}.
...
\section{Evaluering av \texttt{lfgalign}}
\label{sec-5.3}

\texttt{lfgalign} stiller høge krav til inndata: det må vere ferdig
