% Created 2010-11-09 ty. 13:39
\documentclass[12pt,a4paper,draft]{report}
%% That geometry is fugly... ugh, not using it
...
\newcommand{\tittel}{\vspace{40mm}DASP350 Datalingvistikk og språkteknologi mastergradsoppgåve\\\vspace{10mm}Syntaktisk informert frasesamanstilling\vspace{50mm}}
...
Frasesamanstillingane frå \texttt{lfgalign} har ein kvalitativt forskjellig
 informasjon frå den du får med berre N-gramlenkjer eller
 konstituentlenkjer. I denne delen ser eg på moglege bruksområde for
 samanstillingsannotasjonen.
...
Formålet med annotasjonen er jo å lage ein trebank for lingvistisk
 ...
 setningspar i ein trebank, blir det mogleg å søkje etter t.d. alle
 ...
 grensesnitt som skildra i \citet[, under utvikling]{dyvik2009lmp}
 blir dette endå enklare, for dei spørjingane grensesnittet tillèt.
...
I døme \ref{ex:sie-gefallen} i kapittel \ref{SEC:lik-argstr} viste eg
 ...
 objekt) kan me lære slike argumentstrukturskifte; t.d. vil me i \emph{der  Tonfall gefällt mir nicht/jeg liker ikke tonen} ha nok
