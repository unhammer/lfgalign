...
\label{sec-5.1}
 ...
 nytta i \citet{graham2009osr,graham2009fts}, kor språka er tysk og
 engelsk. Setningane, og setningslenkjene, er frå Europarl-korpuset
 \citep{koehn2005emc}, kalla \texttt{europarl} nedanfor. LFG-analysane er
 automatisk disambiguerte og setningssamanstilte (og inkluderer ein
 god del fragmentariske analysar), og er difor ganske ulike det
 materialet eg elles har sett på.
...
\label{sec-5.2}
 ...
 Metoden i \citet{graham2009osr,graham2009fts} finn f-strukturlenkjer
 frå ordlenkjer, med formålet å lage overføringsreglar for
...
0000: (/ 1819 11249.0) 0.16170326
0001: 

foo\footnote{Prolog-filene med f-strukturar, og lenkjer mellom
        ...
        som inkluderer c-strukturar for dei første 1000 på
        \href{http://www.computing.dcu.ie/~ygraham/sample_de.tar.gz}{http://www.computing.dcu.ie/\~ygraham/sample\_de.tar.gz} og
        \href{http://www.computing.dcu.ie/~ygraham/sample_en.tar.gz}{http://www.computing.dcu.ie/\~ygraham/sample\_en.tar.gz}. }. 
