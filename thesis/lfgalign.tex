...
Det viktige forholdet på c-strukturnivå er \emph{dominans}; ein c-struktur
gir ein hierarkisk inndeling av frasestrukturen i setninga, der ein
node på høgare nivå \emph{dominerer} mengder av nodar på lågare nivå. 
...
I figur \ref{fig:enkel-c-lenkje} er dei funksjonelle domena til \emph{regne/regent} 
...
ei setning som «Kven sa du at du likte?» vil objektet til \emph{like}
stå utanfor det funksjonelle domenet til \emph{like}, om me skal lenkje
