...
\subsection{Kor mange av døma treng LPT-korrespondanse for å bli rette}
\label{sec-5.1.2}
...
\texttt{((mo-svla . ankomme) (pro . pro))} men burde vel få
\texttt{((mo-svla . ankomme) (Abrams . Abrams) (Browne . Browne))}.
\subsection{foo}
\label{sec-5.1.3}
...
\begin{itemize}
\item Note taken on \textit{2010-10-19 ty. 17:07} \\
      Standarddømet med reentrancy er i mrs/ka/37.pl mrs/nb/38.pl;
      jaGli/hund er subjekt både for \p{ville} og \p{bjeffe}, difor får
      løysinga ut jaGli-hund to gonger.
\end{itemize}
