...
\end{center}
 ...
 Det er tydeleg at overlappet mellom \texttt{RIA} og \texttt{lfgalign} er svært låg
 på dette materialet\footnote{Denne testen blei køyrt på revisjon
        \texttt{45feb03e3c2b8eefcad2d995e9f5d779c7264565} av \texttt{lfgalign}. }. 
 ...
 \texttt{lfgalign} ingenting ut av f-strukturen (gjennomsnittleg
...
på kvar side tek det \texttt{adjalign} ca. 46 sekund (på ein vanleg
datamaskin med 2,1 GHz, 3GB RAM) å finne alle moglege
lenkjekombinasjonar\footnote{I denne evalueringa vel \texttt{lfgalign} berre første
...
f-strukturlenkjing.
\subsection{Bør LPT-kravet implementerast som eit rangeringskrav?}
\label{sec-5.4.2}
...
\subsection{Rangeringsproblem}
\label{sec-5.4.4}

\subsubsection{argument-argument > argument-adjunkt (ikkje implementert!)}
\label{sec-5.4.4.1}
