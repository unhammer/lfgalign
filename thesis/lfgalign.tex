...
\maketitle
  ...
  \begin{abstract}
    ...
    This thesis describes a novel, \emph{top-down} method of automatic
  ...
  \begin{abstract}
    ...
    Denne oppgåva presenterer ein \emph{top-down}-metode for
...
Sjølv om eg her har argumentert for at formålet med metoden i denne
 ...
 men då må ein nok endre LPT-kravet til å ikkje tillate lenkjer mellom
 pronomen og NP-ar.
...
Men i tillegg til desse måla, vil lenkjene til \texttt{lfgalign} gi
 ...
 mange-mange-lenkjer på c-strukturnivå. \fxnote{treng meir enn berre
 diskontinuerlege einingar her, sidan testsettet ikkje har dei...}
 Slike relasjonar finn me ikkje med ein metode som berre ser på
 lenkjer mellom konstituentdelmengdene av ein N-gramtabell
 \citep{samuelsson2007apa} eller ein metode som ikkje har ei kopling
 frå f-struktur til c-struktur \citep{graham2009fts}.
