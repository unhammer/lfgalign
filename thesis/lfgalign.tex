...
\label{sec-5.1}
 ...
 målspråket\footnote{Kor $e$ står for engelsk og $f$ for fransk, sjølvsagt. }, er ei N-gramsamanstilling $\mathcal{A}$ gitt ved
 ...
 ein-mange-samanstilling ei \emph{ordsamanstilling}; når
 ...
 Dei vanlegaste metodane er basert på sannsynsmodellar\footnote{Det finst au \emph{heuristiske} metodar, t.d. basert på
        ...
        saman i omsetjingar enn ein ville forventa). }, kor den
 ...
 Ein av dei vanlegaste treningsmetodane er \emph{sannsynsmaksimering}, som
 lèt ein rekne ut elles umoglege sannsynsproblem ved å iterativt endre
 modellen slik at skårene blir betre. Eg gir her eit \emph{svært forenkla}
 ...
 samanstillingsførekomstene her i ein tabell; når me ser ordet \emph{Es} i
 ei setning omsett til \emph{There is}, vil tabellraden med \emph{Es} få auka
 frekvensskåre i kolonnane til \emph{There} og \emph{is} -- men sidan dette
 ...
 raden til \emph{es} og \emph{there} ha høgare skåre enn \emph{es} og \emph{is}. Me reknar
...
\end{verbatim}
 ...
 \emph{ikkje} er parallelle -- mi-codeba har <Abrams, sigareti, Browne>,
...
\end{verbatim}
 ...
 vere viktig, viser dette dømet at ein ikkje treng \emph{fullstendig}
 LPT-korrespondanse for å forbetre resultatet.

\begin{itemize}
\item Kva informasjon får me ut av lenkjinga
\item Kva informasjon ville me fått ut av ei rein N-gram-lenkjing

\begin{itemize}
\item \ldots{}og korleis kan N-grambaserte metodar nyttast til tre-lenkjing
    (Samuelsson \& Volk)
\end{itemize}
...
\section{Kor mange setningspar treng LPT-korrespondanse for å bli rette}
\label{sec-5.2}
...
\subsection{Reentrancy og top-down f-strukturlenkjing}
\label{sec-5.5.1}
