...
syntaktisk) som ordet \emph{det} tilfører IP, ligg under I' på georgisk; og
...
ikkje skal lenkjast, sidan \emph{det} og \emph{seg} er lenkja på f-strukturnivå
...
domena til \emph{gaiGo-åpnet} i figur \ref{fig:gaiGo}, sidan
...
målspråket med subskript $_t$, og \emph{det} og \emph{seg} er ulenkja på både
c-strukturnivå og ordnivå\footnote{\label{fn:LL-ordlenkje} Merk at orda \emph{det} og \emph{seg} måtte definerast som ulenkja for
...
\subsection{Informasjonstap som lenkjingskriterium}
\label{sec-1.7.2}
