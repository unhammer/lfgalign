...
Programmet \texttt{lfgalign}\footnote{Tilgjengeleg frå \href{http://github.com/unhammer/lfgalign}{http://github.com/unhammer/lfgalign} som fri og
       ...
       argument). } tek inn LFG-analysane av to
...
\label{SEC:impl-f-rangering}
 ...
 returnere den greina som har best skåre\footnote{Det kan godt hende me har fleire greiner med same skåre -- for
        no blir berre den første returnert. }, gitt ved
 \emph{rank-branch}.
