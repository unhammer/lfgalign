...
evaluere samanstilling (\emph{alignment}, ei mengd lenkjer) av uttrykk som
...
frasesamanstilling – for å finne omsetjingsforhold mellom fleire ord.
...
\citet{samuelsson2006pap}, nyttar dei reint semantiske kriterium, utan
krav om syntaktisk likskap.  Samanstillinga planlagt i XPar-prosjektet
\citep{xpar2008rcn}, som kjem via
...
Dei første metodane for dette kom frå statistisk maskinomsetjing, der
ein berre nytta sannsyn av N-gram-omsetjingar, utan nokon form for
syntaktisk informasjon. Seinare kom metodar for å finne
...
frasar \citep{samuelsson2007apa}. \citet{tinsley2007ept,
hearne2008ccd} viste at slike syntaktisk motiverte metodar kan
forbetre frasebasert stokastisk maskinomsetjing (\emph{PBSMT}). 

I XPar-prosjektet vil ein finne ut om frasesamanstilling kan
forbetrast ved å utnytte det at LFG-grammatikkane for dei ulike språka
er skrivne med same prinsipp lagt til grunn; to parallellstilte
setningar bør ha f-strukturar som er like nok til at me kan
samanstille frasar ved hjelp av likskapen mellom f-strukturane, og i
...
Eg vil i masteroppgåva prøve å samanlikne desse metodane, m.a. i
forhold til dei ikkje-kontinuerlege konstituentane til språk som
georgisk, og utfordringane ved samanstilling av språk med stor
typologisk avstand.

\section{Vegkart}
\label{sec-1.1}

I denne oppgåva skildrar eg ein automatisk metode for å
samanstille frasar. 

Frasesamanstillinga er basert på f-strukturinformasjonen gitt av dei
parallelle grammatikkane, og bottom-up-informasjon om kva for
ordsamanstillingar som er moglege. F-strukturinformasjonen avgrensar
igjen kva for ordsamanstillingar som er moglege, og kva for
c-strukturnodar (syntaktiske frasar) som kan lenkjast.

Eg diskuterer sjølve implementasjonen min i kapittel
\ref{SEC:implementasjon}.

Eg samanliknar så i kapittel \ref{SEC:diskusjon} dei samanstillingane
som er moglege med denne metoden, med det som er mogleg der me berre
har konstituentstruktur (syntaktiske tre) i tillegg til
...
\fixme{\texttt{permute} finn alle moglege permutasjonar av 1-1
LPT-korrespondansar. 
