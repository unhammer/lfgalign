...
\maketitle
  ...
  \begin{abstract}
    ...
    promising, but also suggest specific possibilities for
    improvement.
...
I første omgang spesifiserer eg kva for lenkjer mellom f\hyp{}strukturar og
 c\hyp{}strukturnodar me \emph{ønskjer}. Eg implementerer så eit program
 ...
 f\hyp{}strukturinformasjonen gitt av grammatikkar som er skrivne på felles
 prinsipp, i tillegg til å kunne avgrense lenkjingar med hjelp av
 bottom-up-informasjon om kva for ordlenkjer som er
 moglege. f\hyp{}strukturane avgrensar igjen kva for ordsamanstillingar som
 er moglege, og kva for c\hyp{}strukturnodar (syntaktiske frasar) som kan
...
f\hyp{}strukturlenkjingane frå min implementasjonen og dei som kjem frå ein
N-grambasert metode for lenkjing av f\hyp{}strukturar, på eit større,
...
Frasesamanstilling vil seie lenkjing av (representasjonar av) delar av
 ...
 lenkjing av delar av dependensstrukturar, eller av syntaktiske
...
Innanfor korpuslingvistikken har \citet{piao2001mwu} nytta enkel
 ...
 desse ved hjelp av sannsynsheuristikkar som t-skåre og \emph{Mutual  Information}. Dei køyrer fleire runder med lenkjing av lengre og
...
Seinare resultat har vist at ein \emph{kombinasjon} av syntaktisk
 ...
 ikkje-konstituentar) kan auke skåren i ein
...
lenkjast på f\hyp{}strukturnivå; dei har same referent og speler same rolle
...
Den enklaste lenkjingssituasjonen, f\hyp{}strukturmessig, er der
...
LPT\hyp{}informasjon for å avgjere kva for lenkjing som er korrekt. Men i
...
lenkja.
 ...
 \ex. \label{krav:COORD} Ved lenkjing av f\hyp{}strukturane til to
...
situasjonar vere tilstrekkelege for lenkjing på f\hyp{}strukturnivå, men
...
Det bør kanskje vere grenser for kor langt slik samanføying kan
 ...
 lenkjingsproblemet; i alle situasjonar der me krev LPT\hyp{}korrespondanse
...
\end{tikzpicture}
   \caption{Enkel lenkjing av c\hyp{}strukturnodar mellom norsk og
...
Det andre alternativet er å ikkje gjere forskjell på IP, I' og I når
 det gjeld c\hyp{}strukturlenkjinga. Grunnen til å gjere dette er at
...
\end{tikzpicture}
\caption{Delvis mogleg lenkjing av underordna c\hyp{}strukturnodar mellom georgisk og bokmål}
...
c\hyp{}strukturnodane $n_s$ og $n_t$, som er i lenkja funksjonelle domene,
...
f\hyp{}strukturlenkje som eit ordna par mellom \PRED{}-verdien på kjeldesida
...
kor \emph{det} og \emph{seg} er ulenkja på både c\hyp{}strukturnivå og ordnivå\footnote{\label{fn:LL-ordlenkje} Merk at orda \emph{det} og \emph{seg} måtte definerast som ulenkja for
...
Ord som ikkje projiserer \PRED{}-lenkjer kan likevel tenkjast å ha
 ...
 ikkje gå via nokon f\hyp{}strukturlenkjing), så LPT-kravet gir oss eit
...
\b. Gitt ei mogleg lenkjing av FP og XP, der F er ein funksjonell
    ...
    den funksjonelle kategorien i c\hyp{}strukturlenkjinga. Sidan det ikkje
...
Der det eine språket har eit funksjonsord og det andre språket ikkje
 ...
 på plass blir f\hyp{}strukturlenkjinga avhengig av c\hyp{}strukturforhold, og i
...
argumentstrukturen: argumentfølgje og rekursiv f\hyp{}strukturlenkjing.

\subsection{Rangering ved følgje}
\label{sec-3.8.1}

I \citet[s.~75--76]{dyvik2009lmp} blir det formulert eit
spesialtilfelle av krava for lenkjing på f\hyp{}strukturnivå, der det er
...
Programmet byrjar lenkjinga med f\hyp{}strukturane. Ei
f\hyp{}struktur\emph{samanstilling} er ei mengd med \emph{lenkjer} mellom
individuelle f\hyp{}strukturar. Resultatet av lenkjinga på dette nivået kan
...
Hovudalgoritmen for lenkjing mellom f\hyp{}strukturar er vist i kodefigur
...
LPT\hyp{}korrespondanse mellom to ord (orda er ukjende), er lenkjing
...
utelukke lenkjing av f\hyp{}strukturane $F_s$ og $F_t$ i \Next under:
...
Denne metoden går top-down frå ytre PRED og ned i underordna
 ...
 f\hyp{}struktur med ein indre f\hyp{}struktur, utanom ved ein-mange-lenkjing.

Ein alternativ metode for lenkjing av f\hyp{}strukturane er å byrje med
...
Ein sideverknad av å byrje med ytre lenkjer og gå innover (prosessen
 ...
 f\hyp{}strukturar for setningar der alt me veit om lenkjinga er at
...
lenkjer. Denne blir sendt vidare til c\hyp{}strukturlenkjinga.


\section{Lenkjing av c\hyp{}strukturnodar}
\label{sec-4.3}

Samanstilling mellom f\hyp{}strukturar treng i \texttt{lfgalign} ikkje informasjon
om c\hyp{}strukturen, medan lenkjing av c\hyp{}strukturnodar skjer på grunnlag
...
c\hyp{}strukturar sist\footnote{Som nemnt i del \ref{SEC:fnord} kan funksjonsord gjere
       f\hyp{}strukturlenkjinga avhengig av forhold i c\hyp{}strukturen,
       evt. krevje meir nyansert f\hyp{}strukturlenkjing. Dette har eg
...
\label{SEC:diskusjon}
 ...
 Eg har ikkje gjort nokon evaluering av c\hyp{}strukturlenkjinga; denne er
...
Dei vanlegaste metodane er basert på sannsynsmodellar\footnote{Det finst au \emph{heuristiske} metodar, t.d. basert på
 ...
 til c\hyp{}strukturlenkjing basert på f\hyp{}strukturforhold -- her gir dei
 ...
 nedanfor). f\hyp{}strukturen blir då, i lenkjingsprosessen, ekvivalent med
 ...
 den automatiske ordlenkjinga. Viss f\hyp{}strukturane er korrekte og bygd
...
\label{sec-5.3}
 ...
 argument/adjunkt-lenkjing. Feil i c\hyp{}struktursamanstillinga, derimot,
 vil ikkje få følgjer andre stader (gitt ei viss
 f\hyp{}struktursamanstilling har me heller ingen «val» å ta for lenkjinga
 her).
...
skal kunne lenkje \p{skola} og \p{skole}\footnote{Eller så kunne ein tenkje seg å «hoppe over» mellomliggande
        ...
        krava for f\hyp{}strukturlenkjing. }. Om det finst mange
...
f\hyp{}strukturane i \LLast gir lenkjinga i \Last. Desse pro-elementa på
...
mange-mange-lenkjing berre er to-til-ein så langt, vil LPT\hyp{}informasjon
...
Éin mogleg strategi for å handsame desse vil vere å dele opp
 ...
 sender kvar av desse til vanleg f\hyp{}strukturlenkjing. Men der fragmenta
...
I implementasjonen bør kanskje kravet om LPT\hyp{}korrespondanse difor bli
 ...
 med omsetjingar frå kjeldeordet\footnote{For å ta dette eit steg vidare kan me flytte sjølve rangeringa
        inn i f\hyp{}strukturlenkjinga, som nok vil gjere implementasjonen
...
\subsection{Top-down-lenkjing av f\hyp{}strukturar, og problemet med sykliske grafar}
\label{sec-5.4.2}
...
Då er det eit problem at me følgjer krav \ref{krav:PRED-omgivnad} frå
 kapittel \ref{SEC:ideell}, og går top-down i f\hyp{}strukturlenkjinga i
 ...
 LPT\hyp{}korrespondanse ved lenkjing av \p{p} og \p{r}.
