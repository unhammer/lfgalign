...
\begin{itemize}
\item PRED må ha LPT-korrespondanse
\item arg må ha LPT-korrespondanse med arg/adj

\begin{itemize}
\item problematiser: må me ha \emph{PRED-lenkje} frå arg til arg/adj? (ikkje
    krevd no\ldots{}men kan rangere)
\end{itemize}

\item kryssande f-lenkjer?
\item mange-mange-f-lenkjer?
\end{itemize}
...
\ref{fig:ikkjesub} må altså \emph{det} og \emph{seg} òg vere ordlenkja til
\emph{gaiGo}, på ein måte som let oss sjå på mange-til-ein-ordlenkjene som
